...
export const TRAINING_LINKS: Record<string, TrainingLink> = {
  salesPro: {
    ...
    description: "Core sales enablement path covering Pure Storage portfolio, competitive positioning, and solution selling.",
  ...
  techPro: {
    ...
    description: "Deep-dive technical path covering FlashArray, FlashBlade, Evergreen subscriptions and architecture.",
  ...
  bootcamp: {
    ...
    description: "Intensive hands-on bootcamp for systems engineers covering Pure Storage product stack and design.",
  ...
  implSpec: {
    ...
    description: "Covers installation, configuration, troubleshooting, and support of Pure Storage platforms.",
  ...
  aspFoundations: {
    ...
    description: "Required foundational course for ASP (Authorized Support Partner) programme entry.",
  ...
  aspStoragePro: {
    ...
    description: "FlashArray/FlashBlade Storage Professional Certification exam — required for ASP eligibility.",
  ...
  aspSupportSpec: {
    ...
    description: "FlashArray/FlashBlade Support Specialist Certification exam — required for ASP eligibility.",
