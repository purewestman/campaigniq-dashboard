  ...
  const summaryHtml = `
    <div class="section-block">
      ...
      <div style="background:${isCompliant ? "#f0fdf4" : "#fffbeb"};border:1px solid ${isCompliant ? "#bbf7d0" : "#fef3c7"};padding:16px;border-radius:12px;font-size:13px;line-height:1.6;color:#1f2937;">
        ...
        <p style="margin-bottom:8px;">If one user has completed FlashArray ASP Foundations and the same person completed Pure Storage Professional Certification, the partner will be issued with ASP Partner Badge while pursuing FlashBlade Support Specialist cert or certification.</p>
        <p style="color:#e11d48;font-weight:700;font-size:12px;">** Individual must earn the FlashBlade Support Specialist cert or certification within 12 months of the Storage Professional certification.</p>
      ...
      <table style="width:100%;border-collapse:collapse;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
        <thead>
          <tr style="background:#5A6359;">
            ...
            <th style="padding:12px;text-align:center;font-size:11px;font-weight:700;color:#fff;">Storage Pro</th>
